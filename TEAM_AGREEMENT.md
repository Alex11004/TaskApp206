...
| :--- | :--- | :--- |
| [Luis Castillo] | Líder (Arquitecto) | `@Alex11004` |
| [Yeison Guarin] | Desarrollador | `@yeisonguarin` |
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos de [Lunes] a [Viernes] a las [2:00 PM] de forma [Virtual].
...
* **Calidad antes que velocidad:** Ningún código se envía a revisión si tiene errores en la terminal o si rompe el diseño en dispositivos móviles.
...
3. **Decisiones Técnicas:** En caso de desacuerdo sobre cómo programar algo, se debatirá con argumentos técnicos y la decisión final será tomada por el **Líder** (Luis Alejandro Castillo Garnica).
